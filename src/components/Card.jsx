...
import image from "../static/images/cardImage.png";
    ...
    >
      <Card className={classes.root}>
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            <Typography paragraph>Theory:</Typography>
            <Typography paragraph>
              React (also known as React.js or ReactJS) is an open-source, front
              end, JavaScript library[3] for building user interfaces or UI
              components. It is maintained by Facebook and a community of
              individual developers and companies.[4][5][6] React can be used as
              ...
              usually requires the use of additional libraries for
